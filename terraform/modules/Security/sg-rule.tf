...
resource "aws_security_group_rule" "inbound-alb-http" {
  ...
  security_group_id = aws_security_group.VIC["ext-alb-sg"].id
}
...
resource "aws_security_group_rule" "inbound-ssh-bastion" {
  ...
  type              = "ingress"
  cidr_blocks       = ["0.0.0.0/0"]
  security_group_id = aws_security_group.VIC["bastion-sg"].id
}
...
resource "aws_security_group_rule" "inbound-nginx-http" {
  ...
  to_port                  = 443
  protocol                 = "tcp"
  source_security_group_id = aws_security_group.VIC["ext-alb-sg"].id
  security_group_id        = aws_security_group.VIC["nginx-sg"].id
}
...
resource "aws_security_group_rule" "inbound-ialb-https" {
  ...
  to_port                  = 443
  protocol                 = "tcp"
  source_security_group_id = aws_security_group.VIC["nginx-sg"].id
  security_group_id        = aws_security_group.VIC["int-alb-sg"].id
}
...
resource "aws_security_group_rule" "inbound-web-https" {
  ...
  to_port                  = 443
  protocol                 = "tcp"
  source_security_group_id = aws_security_group.VIC["int-alb-sg"].id
  security_group_id        = aws_security_group.VIC["webserver-sg"].id
}
...
resource "aws_security_group_rule" "inbound-nfs-port" {
  ...
  to_port                  = 2049
  protocol                 = "tcp"
  source_security_group_id = aws_security_group.VIC["webserver-sg"].id
  security_group_id        = aws_security_group.VIC["datalayer-sg"].id
}
